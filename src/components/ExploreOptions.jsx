  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto px-8 pt-8 pb-16">
      <div className="text-center mb-6">
        <p className="text-[11px] font-bold text-gray-500 tracking-wider uppercase mb-1">
      ...
      <div className="relative group">
        <div className="flex gap-5 overflow-x-auto pb-6 pt-2 hide-scrollbar snap-x items-center px-2">
          {options.map((opt, idx) => (
            ...
            >
              <div className="rounded-2xl overflow-hidden shadow-[0_4px_12px_rgba(0,0,0,0.08)] relative aspect-[4/2.5] bg-gray-100">
                <img
                  src={opt.img}
                  alt={opt.title}
                ...
                {opt.subtitle && (
                  <div className="absolute inset-0 p-4 font-bold text-gray-800 text-sm w-2/3 leading-tight hidden lg:block">
                    {opt.subtitle}
                  </div>
                )}
              </div>
